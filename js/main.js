...
function initScrollAnimations() {
        ...
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                if (entry.target.classList.contains('research-grid') || 
                    entry.target.classList.contains('patents-grid')) {
                    const cards = entry.target.querySelectorAll('.research-card, .patent-card');
    ...
    const animatedElements = document.querySelectorAll(
        '.hero-content, .about-content, .research-grid, .patents-grid, .timeline-item, .contact-content'
    );
    ...
    const cards = document.querySelectorAll('.research-card, .patent-card');
    cards.forEach(card => {
...
function initCardEffects() {
    const cards = document.querySelectorAll('.research-card, .patent-card, .highlight-card');
...
setTimeout(initSocialEffects, 1000);
...
document.addEventListener('keydown', (e) => {
    ...
    if (konamiCode.join(',') === konamiSequence.join(',')) {
        ...
        setTimeout(() => {
            ...
            showNotification('Colors restored!', 'info');
        }, 5000);
